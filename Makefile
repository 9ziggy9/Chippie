...
OBJECTS=./build/chip8memory.o ./build/chip8registers.o ./build/chip8stack.o ./build/chip8keyboard.o ./build/chip8.o

all: chip8stack chip8memory chip8registers chip8keyboard chip8 chippie
